...
class _ExpenseInputScreenState extends State<ExpenseInputScreen> {
  ...
  // final UserController userControllern = Get.put(UserController());
                    ...
                    (index) => GestureDetector(
                      ...
                      child: Container(
                        decoration: BoxDecoration(
                          ...
                          color: _expanseMethod == _radioValues[index]['value']
                ...
                onPressed: () {
                  if (_formKey.currentState!.validate()) {
                    ...
                    if (_Expanse_category != null && _expanseMethod != null) {
                      ...
                      showTopTitleSnackBar(context, Icons.comment_sharp, "Expense Recoded");
                    }
                  }
                },
              ),
