...
class EditIncomeTransactionScreen extends StatefulWidget {
  final Transaction transaction;

  EditIncomeTransactionScreen({
    Key? key,
    required this.transaction,
  }) : super(key: key);

  @override
  State<EditIncomeTransactionScreen> createState() => _EditIncomeTransactionScreenState();
}

class _EditIncomeTransactionScreenState extends State<EditIncomeTransactionScreen> {
  ...
  void initState() {
    super.initState();
    _titleIncomeController.text = widget.transaction.title.toString();
    _notesIncomeController.text = widget.transaction.additional.toString();
    _amountIncomeController.text = widget.transaction.amount.toString();
    _incomeMethod = widget.transaction.method.toString();
    _Income_category = widget.transaction.category.toString();
    _incomeMethod = widget.transaction.method.toString();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Edit Income Transaction'),
        centerTitle: true,
                  ...
                  onPressed: () {
                    if (_formKey.currentState!.validate()) {
                      ...
                      if (_Income_category != null && _incomeMethod != null) {
                        incomeController.updateIncomeRecode(
