...
class FamilyEditExpenseTransactionScreen extends StatefulWidget {
  final FamilyTransaction transaction;

  FamilyEditExpenseTransactionScreen({
    Key? key,
    required this.transaction,
  }) : super(key: key);

  @override
  State<FamilyEditExpenseTransactionScreen> createState() => _FamilyEditExpenseTransactionScreenState();
}

class _FamilyEditExpenseTransactionScreenState extends State<FamilyEditExpenseTransactionScreen> {
                  ...
                  onPressed: () {
                    if (_formKey.currentState!.validate()) {
                      ...
                      if (_Expanse_category != null && _expanseMethod != null) {
                        ...
                        Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => FamilyTransactionScreen()));
